...
function getWelcomeMessage() {
    return {
        type: 'photo',
        media: 'https://i.postimg.cc/wBfhhrBZ/img2.jpg',
        caption: `🙈 **NATALIA PADILLA😈**
    ...
    try {
        ...
        if (query.data === 'metodo_pago') {
            await bot.editMessageMedia(
                {
                    type: 'photo',
                    media: 'https://i.postimg.cc/yYHSSKP9/img7.jpg',
                    caption: `𝗛𝗢𝗟𝗜 💕🔥
...
📌 **EXTRANJERO 🌍**`,
        ...
        // ===== QR BOLIVIA =====
            ...
            await bot.editMessageMedia(
                {
                    type: 'photo',
                    media: 'https://i.postimg.cc/VNzj1y7m/Whats-App-Image-2026-02-06-at-14-11-31-(2).jpg',
